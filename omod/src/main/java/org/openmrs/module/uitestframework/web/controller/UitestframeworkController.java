 ...
 */
package org.openmrs.module.uitestframework.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.UitestframeworkController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class UitestframeworkController {
